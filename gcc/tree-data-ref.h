...
public:
  dr_with_seg_len (data_reference_p d, tree len, unsigned HOST_WIDE_INT size,
    ...
    {}
  dr_with_seg_len (data_reference_p d, tree len, tree len2, tree len_for_outer_loop,
                   unsigned HOST_WIDE_INT size, unsigned int a)
    : dr (d), seg_len (len), seg_len2 (len2), seg_len_for_outer_loop (len_for_outer_loop), access_size (size), align (a)
    {}
