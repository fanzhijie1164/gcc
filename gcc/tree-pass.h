...
extern gimple_opt_pass *make_pass_lro (gcc::context *ctxt);
...
extern gimple_opt_pass *make_pass_bool_aggregate (gcc::context *ctxt);
...
extern simple_ipa_opt_pass *make_pass_ipa_class_reorg (gcc::context *ctxt);
...
extern simple_ipa_opt_pass *make_pass_ipa_arrayremapping (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_extend_auto_profile (gcc::context *ctxt);
...
extern simple_ipa_opt_pass *make_pass_ipa_post_devirt (gcc::context *ctxt);
...
extern rtl_opt_pass *make_pass_csr_opt(gcc::context *ctxt);
...
extern void execute_regular_ipa_post_whole_program_transforms (void);
